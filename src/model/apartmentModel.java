...
public class apartmentModel {
    ...
    private static String SELECT_APTNAME_BUILDINGNAME_LOCATION_BY_APTID = "SELECT apt_name,b_name,location,rent FROM apartment NATURAL JOIN building WHERE apt_id = ?";
    private static String SELECT_ALL_APT_BY_BID = "SELECT * FROM apartment WHERE b_id = ?";
    private static final String SELECT_RENT_BY_APT_ID = "SELECT apt_name,rent FROM apartment WHERE apt_id=?";
    
    
     private static String SELECT_ALL_AVAILABLE = "SELECT * FROM apartment WHERE available = 'YES'";
    ...
    public ResultSet VIEW_ALL_AVAILABLE()
    {
        try {
     ...
     public ResultSet getAptNameRentByAptId(int apt_id)
    {
        try {
            pst = con.prepareStatement(SELECT_RENT_BY_APT_ID);
            pst.setInt(1, apt_id);
    ...
    public ResultSet GET_ALL_APT_BY_BID(int b_id )
    {
        try {
            pst = con.prepareStatement(SELECT_ALL_APT_BY_BID); 
            pst.setInt(1, b_id);
            return rs = pst.executeQuery();   

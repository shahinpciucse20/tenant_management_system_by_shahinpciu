...
public class ViewInActiveTenant extends javax.swing.JFrame {
    ...
    public ViewInActiveTenant() {
        initComponents();
        tenModel = new tenantModel();
        aModel = new apartmentModel();
        
        displayActiveTenants(tenModel.VIEW_ALL_INACTIVE());
   ...
   setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource(Values.ICON_PATH)));  
    ...
    {
        displayActiveTenants(tenModel.SEARCH_BY_INACTIVE_NAME(text));
    }
    
    private void searchByNID(String nid)
    {
        long id = Long.parseLong(nid);
        displayActiveTenants(tenModel.SEARCH_BY_INACTIVE_ID(id));
    }
    
    private void searchByMobile(String text)
    {
        
        displayActiveTenants(tenModel.SEARCH_BY_INACTIVE_MOBILE(text));
    }   
    ...
    public static void displayActiveTenants(ResultSet rs)
    {
        try {                        
            ...
            DefaultTableModel recordTable = (DefaultTableModel)tbl_InactiveTenant.getModel();
            ...
            Logger.getLogger(ViewInActiveTenant.class.getName()).log(Level.SEVERE, null, ex);
        }        
    }
    ...
    private void initComponents() {
        ...
        tbl_InactiveTenant = new javax.swing.JTable();
        ...
        jLabel2.setText("Inactive Tenants");
        ...
        tbl_InactiveTenant.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        tbl_InactiveTenant.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbl_InactiveTenant.setRowHeight(30);
        tbl_InactiveTenant.setSelectionBackground(new java.awt.Color(255, 0, 0));
        tbl_InactiveTenant.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_InactiveTenantMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbl_InactiveTenant);
        if (tbl_InactiveTenant.getColumnModel().getColumnCount() > 0) {
            tbl_InactiveTenant.getColumnModel().getColumn(2).setMinWidth(120);
            tbl_InactiveTenant.getColumnModel().getColumn(2).setMaxWidth(120);
            tbl_InactiveTenant.getColumnModel().getColumn(4).setMinWidth(60);
            tbl_InactiveTenant.getColumnModel().getColumn(4).setMaxWidth(60);
            tbl_InactiveTenant.getColumnModel().getColumn(5).setMinWidth(70);
            tbl_InactiveTenant.getColumnModel().getColumn(5).setMaxWidth(80);
            tbl_InactiveTenant.getColumnModel().getColumn(6).setMinWidth(100);
            tbl_InactiveTenant.getColumnModel().getColumn(6).setMaxWidth(120);
        }
        ...
        btn_close.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/resetWhite-24x.png"))); // NOI18N
        btn_close.setText("RESET");
        btn_close.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_closeActionPerformed(evt);
            }
        });
        jPanel2.add(btn_close, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 570, 150, 40));
        ...
        jPanel2.add(btn_close2, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 570, 140, 40));
    ...
    private void tbl_InactiveTenantMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_InactiveTenantMouseClicked
        
    }//GEN-LAST:event_tbl_InactiveTenantMouseClicked
    ...
    private void lbl_viewProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_viewProfileMouseClicked
        if(tbl_InactiveTenant.getSelectedRow()>=0){
            int row = tbl_InactiveTenant.getSelectedRow();
            String nid = tbl_InactiveTenant.getValueAt(row, 0).toString();
    ...
    private void btn_printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_printActionPerformed
        Print.printJTable(tbl_InactiveTenant, "All Inactive Tenants");
    ...
    private static javax.swing.JTable tbl_InactiveTenant;

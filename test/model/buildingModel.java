...
public class buildingModel {
    ...
    //~~~SQL QUERY ~~~//
    private static String INSERT = "INSERT INTO building ( b_name, num_of_apt, location ) VALUES (?, ?, ?)";
    private static String UPDATE = "UPDATE building SET b_name = ?, location = ? WHERE b_id = ?";
    private static String DELETE = "DELETE FROM building WHERE b_id = ?";
    private static String SELECT_ALL = "SELECT * FROM building";  
    private static String SELECT_ALL_ID = "SELECT b_id FROM building"; 
    private static String SELECT_NAME_BY_ID = "SELECT b_name FROM building WHERE b_id= ?";
    private static String SELECT_LAST_ID = "SELECT b_id FROM building ORDER BY b_id DESC LIMIT 1";
    
    private static String SELECT_NUM_OF_BUILDING = "SELECT COUNT(*) AS num_of_building FROM building";
    private static String SELECT_BY_ID = "SELECT * FROM building WHERE b_id = ?";
    private static String SELECT_BY_NAME = "SELECT * FROM building WHERE b_name LIKE ";
    private static String SELECT_BY_LOCATION = "SELECT * FROM building WHERE location LIKE ";
    
    private static String SELECT_NUM_OF_APT_BY_ID = "SELECT num_of_apt FROM building WHERE b_id =?";
    private static String UPDATE_NUM_OF_APT_BY_ID = "UPDATE building SET num_of_apt = ? WHERE b_id =?";

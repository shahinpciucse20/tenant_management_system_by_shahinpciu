...
public class UpdateTenantPage extends javax.swing.JFrame { 
    ...
    {
        ResultSet rs = Ten.SEARCH_BY_NAME(text);
        displayAllTenant(rs);
    }
    ...
    private void searchByNID(String nid)
    {
        ...
        ResultSet rs = Ten.SEARCH_BY_ID(id);
        displayAllTenant(rs);
    }
    ...
    private void searchByMobile(String text)
    {
        ...
        ResultSet rs = Ten.SEARCH_BY_MOBILE(text);
        displayAllTenant(rs);
    }
        ...
        try {                        
            ...
            {           
                ...
                for(int i =1 ; i<=q ; i++)
                {
                    ...
                    columData.add(rs.getInt("mobile"));
    ...
    private void initComponents() {
        ...
        btn_removebuilding1 = new javax.swing.JButton();
        ...
        middlebox.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 500, 160));
        ...
        middlebox.add(txt_securitydeposit, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 370, 310, 80));
        ...
        middlebox.add(txt_startingmonth, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 370, 190, 80));
        ...
        rightbox.add(btn_close, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 320, 130, 60));
        ...
        rightbox.add(btn_reset, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 320, 130, 60));
        ...
        rightbox.add(btn_add, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, -1, 60));

        btn_removebuilding1.setBackground(new java.awt.Color(255, 51, 51));
        btn_removebuilding1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btn_removebuilding1.setForeground(new java.awt.Color(255, 255, 255));
        btn_removebuilding1.setText("X   REMOVE TENANT");
        btn_removebuilding1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_removebuilding1ActionPerformed(evt);
            }
        });
        rightbox.add(btn_removebuilding1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 410, 430, 60));
        ...
        table.setPreferredSize(new java.awt.Dimension(3110, 250));
        ...
        TableHolder.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 1850, 270));
        ...
        cb_SearchFilter.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "NAME", "MOBILE", "APT ID" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cb_SearchFilter, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txt_Search, javax.swing.GroupLayout.PREFERRED_SIZE, 608, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(TableHolder, javax.swing.GroupLayout.PREFERRED_SIZE, 1876, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                    ...
                    .addComponent(TableHolder, javax.swing.GroupLayout.PREFERRED_SIZE, 291, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addContainerGap(67, Short.MAX_VALUE)))
        );

        table.add(jPanel1, java.awt.BorderLayout.CENTER);
    ...
    private void btn_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addActionPerformed
       ...
       if(validInput()==true)
       {
           ...
           JOptionPane.showMessageDialog(this, "Tenant Update"); 
       }       
       else{
    ...
    private void btn_removebuilding1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_removebuilding1ActionPerformed
        if(txt_nid.getText().length()>0)
        {
            ...
            if(deleteItem == JOptionPane.YES_OPTION)
            {
                long nid = Long.parseLong(txt_nid.getText());
                deleteTenant(nid);
                JOptionPane.showMessageDialog(this, "Tenant Successfully Removed!");
                clear();
                displayAllTenant(Ten.VIEW_ALL());
    ...
    }//GEN-LAST:event_btn_removebuilding1ActionPerformed
    ...
    private javax.swing.JButton btn_removebuilding1;

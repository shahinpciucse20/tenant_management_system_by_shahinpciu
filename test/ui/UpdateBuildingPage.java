...
public class UpdateBuildingPage extends javax.swing.JFrame {
    ...
    private buildingModel B = new buildingModel();    
    ...
    private void initComponents() {
        ...
        tbl_building.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        TableHolder.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 730, 390));

        form.add(TableHolder, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 150, 730, 390));
        ...
        form.add(txt_Search, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 50, 370, 50));
        ...
        form.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 50, 100, 50));
        ...
        form.add(cb_SearchFilter, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 50, 130, 50));
    ...
    private void btn_removebuildingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_removebuildingActionPerformed
        if(txt_bname.getText().length()>0 && txt_location.getText().length()>0 && txt_bid.getText().length()>0)
        {
            int deleteItem = JOptionPane.showConfirmDialog(null,Values.getDeleteWarningMessage(), "Do You Want to Remove?",JOptionPane.YES_NO_OPTION );
